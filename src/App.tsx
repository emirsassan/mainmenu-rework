...
import type { MinecraftScreen, OnlineStatus, SocialMedia } from "./entities";
    ...
    >
      ...
      <div className="flex justify-between items-start">
        ...
        <div className="backdrop-blur-md bg-white/10 rounded-2xl p-4 border border-white/20 shadow-2xl">
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <div className={`absolute -bottom-1 -right-1 w-4 h-4 rounded-full ${getStatusColor(onlineStatus)} border-2 border-gray-900`} />
            </div>
            <div>
        ...
        <div className="text-center">
          <h1 className="text-white text-5xl font-bold tracking-wider select-none animate-pulse bg-gradient-to-r from-cyan-400 via-purple-500 to-pink-500 bg-clip-text text-transparent">
            CELESTIAL
          </h1>
        ...
        {menuButtons.map((button) => (
          ...
          >
            <div className="flex items-center justify-between">
              ...
              <div className={`transition-all duration-300 ${hoveredButton === button.id ? "translate-x-2 opacity-100" : "translate-x-0 opacity-50"}`}>
