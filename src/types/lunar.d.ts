...
interface LunarNamespace {
    ...
    hostedWorlds?: {
        ...
        onModalCallback(arg0: com_moonsworth_lunar_client_HOHCOOCHHICCOOHCIRHRCOICORRRRI_HCCICHOOHHOIHRRCROCROHRIIOHOCC_HRRIHRRICRORHHRIIOIOHOOHIHIRIC_IOHCRIOROICRICIICHRHCCORHROOCO_IIRHRHIOCCRICHIIROHHCHOHROIHHHIOHCRIOROICRICIICHRHCCORHROOCO, arg1: string): void;
    };
    alerts?: {
    ...
    socialMedia?: {
        openSocialMedia(arg0: com_moonsworth_lunar_client_RRHIIIRIHOHOHRCHHRRHOCIOICCRCC_CIRCIRHCCIOIIRORRORHIHICOIORCI_IIRHRHIOCCRICHIIROHHCHOHROIHHH_HCCICHOOHHOIHRRCROCROHRIIOHOCC_IOHCRIOROICRICIICHRHCCORHROOCO): void;
    };
    homeRadio?: {
        mute(): void;
    ...
    openUri(arg0: string, arg1: com_lunarclient_gameipc_browser_v1_OpenUrlRequestInitiator): void;
...
window.lunar = {
    ...
    hostedWorlds  = {
        ...
        onModalCallback: (arg0: com_moonsworth_lunar_client_HOHCOOCHHICCOOHCIRHRCOICORRRRI_HCCICHOOHHOIHRRCROCROHRIIOHOCC_HRRIHRRICRORHHRIIOIOHOOHIHIRIC_IOHCRIOROICRICIICHRHCCORHROOCO_IIRHRHIOCCRICHIIROHHCHOHROIHHHIOHCRIOROICRICIICHRHCCORHROOCO, arg1: string) => window.lunar.invoke(window.lunar.token, arg0, arg1),
    },
    alerts  = {
    ...
    setScreen: (arg0: com_moonsworth_lunar_client_HOHCOOCHHICCOOHCIRHRCOICORRRRI_HCCICHOOHHOIHRRCROCROHRIIOHOCC_IOHCRIOROICRICIICHRHCCORHROOCO_HRRIHRRICRORHHRIIOIOHOOHIHIRIC) => window.lunar.invoke(window.lunar.token, arg0),
    ...
    openUri: (arg0: string, arg1: com_lunarclient_gameipc_browser_v1_OpenUrlRequestInitiator) => window.lunar.invoke(window.lunar.token, arg0, arg1),
